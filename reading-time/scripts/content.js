...
/*
    ...
    // Use the same styling as the publishs information in an article's header
    badge.classList.add('color-selector-text', 'type--caption');
    ...
    heading.addEventListener("click", () => {
        ...
        tempDev.style.backgroundColor = randomColor();
        if (activeElem) {
            activeElem.insertAdjacentElement("afterend", badge);
        }
        setListener(tempDev);
    });
}
...
if (article) {
    ...
    // https://developer.mozilla.org/en-US/docs/Web/API/Element/insertAdjacentElement
    (date ?? heading).insertAdjacentText('afterend', badge.textContent); //badge
}